...
export function createDraftFromMovement(movement, day, profile) {
  ...
  return {
    ...
    eventStartTime: movement.eventStartTime && movement.eventStartTime !== movement.departureTime ? movement.eventStartTime : "",
    eventEndTime: movement.eventEndTime && movement.eventEndTime !== movement.endTime ? movement.eventEndTime : "",
